      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-6 bg-indigo-600/8 rounded-3xl blur-3xl" />

            <div className="relative bg-[#0c0c14] border border-white/[0.08] rounded-2xl overflow-hidden shadow-2xl">
              {/* Widget header */}
              <div className="px-4 py-3.5 bg-gradient-to-r from-indigo-600 to-indigo-700 flex items-center gap-3">
              ...
              <div className="px-4 py-3 border-t border-white/[0.06] flex items-center gap-2">
                ...
                <button className="w-8 h-8 rounded-xl bg-indigo-600 flex items-center justify-center flex-shrink-0">
